...
class textPainter{
   ...
   */
     ...
     * @access public
     */
    public function setTextColor($R=255, $G=255, $B=255){
      $this->textColor = imagecolorallocate ($this->img, $R, $G, $B);
    }

    public function setText($text, $x, $y, $fontSize) {
      imagettftext($this->img, $fontSize, 0, $x, $y, $this->textColor, $this->fontFile, $text);
    }
    ...
    public function show(){
      ...
      switch ($this->format){
        case "JPEG":
          ...
          break;
        case "PNG":
          imagepng($this->img, 'statscard.png');
          break;
        case "GIF":
          imagegif($this->img);
          break;
